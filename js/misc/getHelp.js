...
<p>White, pink or brown noise can be used to modulate, which gives ragged or glitchy effects, especially with brown noise set by the Noise selector in the Global section.</p>
...
<td>Noise, type determined by Noise selector in the Global section (note the Rate control has no effect here)</td>
</tr>
</tbody>
</table>
`,
...
`,
  ...
  noiseLevel1: {
    controls: {
      level: {
        html: `<h3>Noise</h3>
<p>Controls the amount of noise mixed into the sound, for creating breathy effects. The type of noise is set using the Noise selector in the Global section.</p>
`,
      },
    },
  },
...
${help.modules.transient.controls.masterVolume.html}
...
${help.modules.transient.controls.velocityType.html}`,
    controls: {
      adjuster: {
