...
export default class DelayEffectModule extends AudioModule {
    ...
    _destroyDelayNodes() {
        if (this._delay1) {
            ...
            this._feedback1.disconnect();
            this._feedback2.disconnect();
            this._delay1 = undefined;
            this._delay2 = undefined;
        }
    }
    ...
    _createDelayNodes() {
        ...
        this._delay1 && this._destroyDelayNodes();
    ...
    _update() {
        ...
        this._delay1 && this._delay1.delayTime.setTargetAtTime(time*10, this._now, this._minimumTimeConstant);
        this._delay2 && this._delay2.delayTime.setTargetAtTime(time*10, this._now, this._minimumTimeConstant);
